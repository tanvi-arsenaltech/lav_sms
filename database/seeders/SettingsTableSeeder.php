...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_name', 'description' => 'Institude Management System'],
            ['type' => 'term_ends', 'description' => '01/01/2024'],
            ['type' => 'term_begins', 'description' => '01/01/2024'],
            ['type' => 'phone', 'description' => '0123456789'],
            ['type' => 'address', 'description' => 'Nadiad'],
            ['type' => 'system_email', 'description' => 'institude12@gmail.com'],
